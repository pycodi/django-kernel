...
urlpatterns = [
    ...
    url(r'^password_change/$', kv.PasswordChangeView.as_view(), name='password_change'),
    url(r'^password_change/done/$', kv.PasswordChangeDoneView.as_view(), name='password_change_done'),
    url(r'^password_reset/$', kv.PasswordResetView.as_view(), name='password_reset'),
    url(r'^password_reset/done/$', kv.PasswordResetDoneView.as_view(), name='password_reset_done'),
